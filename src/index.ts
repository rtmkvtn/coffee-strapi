  ...
  async bootstrap({strapi}) {
    ...
    const productsByCategory = {
      'Напитки': {
        ...
        'Авторский чай': [
          ...
          { name: 'Малина-грейпфрут', weight: '450мл', price: 200, locale: 'ru' },
          { name: 'Облепиховый с мятой', weight: '450мл', price: 200, locale: 'ru' }
        ],
        'Не кофе': [
          { name: 'Пунш брусника-малина', weight: '', price: 150, locale: 'ru' },
        ...
        'Лимонады': [
          { name: 'Маракуйя-розмарин', weight: '350мл', price: 180, locale: 'ru' },
          { name: 'Малиновый', weight: '350мл', price: 180, locale: 'ru' },
          { name: 'Манго-апельсин', weight: '350мл', price: 180, locale: 'ru' },
          { name: 'Клубничный апероль', weight: '350мл', price: 180, locale: 'ru' },
          { name: 'Мандарин-имбирь', weight: '350мл', price: 180, locale: 'ru' }
        ],
        'Смузи': [
      ...
      'Еда': {
        'Шаурма': [
          ...
          { name: 'Шаурма + 5 наггетсов', weight: '', price: 270, locale: 'ru' }
        ],
        'Салаты': [
        ...
        'Блинчики': [
          ...
          { name: 'С ветчиной и сыром', weight: '2шт', price: 150, locale: 'ru' },
    ...
    for (const categoryData of categories) {
      ...
      for (const subcategoryData of subcategories) {
        ...
        const products = productsByCategory[category.name][subcategory.name].map((product, index) => ({
          name: product.name,
